...
function carregatext() {
  ...
  xhttp.onreadystatechange = function() {
    if (xhttp.readyState == 4 && xhttp.status == 200) {
	  ...
	  document.getElementById("contador").innerHTML = "To make the search easier, you can read <a href='info.html' target='_blank'>More information</a> and the lists of  <a href='manuscripts.html' target='_blank'>manuscripts</a> and <a href='feasts.html' target='_blank'>festivities</a>. There are nowadays " + mssermo.length + " manuscripts and " + atrib.length + " sermons in the Database.";
	  }
   }
    ...
    if (xhttp.readyState == 4 && xhttp.status == 200) {
	 ...
	 for (d = 0; d < resposta; d++) {  //Repassa totes les etiquetes i obté l'atribut desitjat
	  ...
	  if (pagines == 0) {
            ...
            document.getElementById("respostatext").innerHTML = "<table border='0' style='margin: auto;'><tr><td> Showing " + minpag + " to " + coincid + " of " + coincid + " - Page " + curpage + " of " + pagines;
		 } else if (curpage == 1) { // Si has arribat al final de la primera pàgina. En aquesta secció s'ha de posar les fletxes
            document.getElementById("respostatext").innerHTML = "<table border='0' style='margin: auto;'><tr><td> Showing " + minpag + " to " + maxpag + " of " + coincid + " - Page " + curpage + " of " + pagines + "  <button class ='btn' onclick='mesu()'> Next </button></td></tr></table>";
		 } else if (curpage == pagines) { // Si has arribat al final de les respostes = al final de la última pàgina
            document.getElementById("respostatext").innerHTML = "<table border='0' style='margin: auto;'><tr><td> Showing " + minpag + " to " + coincid + " of " + coincid + " - Page " + curpage + " of " + pagines + "  <button class ='btn' onclick='menysu()'> Previous </button></td></tr></table>";
		 } else {
		    document.getElementById("respostatext").innerHTML = "<table border='0' style='margin: auto;'><tr><td> Showing " + minpag + " to " + maxpag + " of " + coincid + " - Page " + curpage + " of " + pagines + "  <button class ='btn' onclick='menysu()'> Previous </button>&nbsp;&nbsp;<button class ='btn' onclick='mesu()'> Next </button> </td> </tr> </table>";
		    }
         }
      }
   }
    ...
    if (xhttp.readyState == 4 && xhttp.status == 200) {
      ...
      for (d = 0; d < resposta; d++) {
		 ...
		 if  (curpage == 1 && casum == paraula && coincid < maxpag) {
		   	coincid++
			text += "<hr/><table border='0' width='90%'><tr><td width='15%'>Thema: </td><td>" + atrib[d].innerHTML + "</td></tr><tr><td>Author:</td><td>" +	atrib[d].parentNode.getAttribute("author") + "</td></tr><tr><td>Place:</td><td>" + atrib[d].parentNode.getAttribute("settlement") + ", " + atrib[d].parentNode.getAttribute("repository") + ", " + atrib[d].parentNode.getAttribute("idno") + "</td></tr></table>";
			...
			text+="<table border='0' width='90%'><tr><td width='15%'>edition:</td><td>" + atrib[d].parentNode.getAttribute("editor") + ", <i>" + atrib[d].parentNode.getAttribute("title") + "</i>, " + atrib[d].parentNode.getAttribute("pubPlace") + atrib[d].parentNode.getAttribute("publisher") + atrib[d].parentNode.getAttribute("date") + atrib[d].parentNode.getAttribute("pags") + "</td></tr></table>";
         ...
         // <a href class='btn'=" + atrib[d].parentNode.getAttribute("web") + " target = '_blank'>Link</a>
 		 if  (curpage > 1 && casum == paraula && coincid >= minpag && coincid <= maxpag) { // Les 'normals' a partir de la pàgina 2
            coincid++
			text += "<hr/><table border='0' width='90%'><tr><td width='15%'>Thema: </td><td>" + atrib[d].innerHTML + "</td></tr><tr><td>Author (preacher):</td><td" + atrib[d].parentNode.getAttribute("author") + "</td></tr><tr><td>Place:</td><td>" + atrib[d].parentNode.getAttribute("settlement") + ", " + atrib[d].parentNode.getAttribute("repository") + ", " + atrib[d].parentNode.getAttribute("idno") + "</td></tr></table>";
			
			if ( sipdf !="") {
			text += "<table border='0' width='90%'><tr><td width='15%'>lectronic edition:</td><td>" + "<a href=" + sipdf + " class='btn' target= '_blank'>Ver PDF</a></td></tr></table>";
			 } else {
				}
		...
		if  (pagines == 1 && coincid == 0) {
			 document.getElementById("respostatext").innerHTML = "The DB does not contain any sermon for this preacher.";
		 } else if (pagines == 1 && curpage ==1) { // Si estàs (al final de la) primera pàgina i només hi ha una pàgina. No posar  fletxes
            document.getElementById("respostatext").innerHTML = "<table border='0' style='margin: auto;'><tr><td> Showing " + minpag + " to " + coincid + " of " + numms + " - Page " + curms + " of " + pagines + "</td></tr></table>";
		 } else if (curpage == 1) { // Si has arribat al final de la primera pàgina, només fletxa Next
            document.getElementById("respostatext").innerHTML = "<table border='0' style='margin: auto;'><tr><td> Showing " + minpag + " to " + maxpag + " of " + numms + " - Page " + curms + " of " + pagines + "  <button class='btn' onclick='mesms()'> Next </button></td></tr></table>";
            ...
            document.getElementById("respostatext").innerHTML = "<table border='0' style='margin: auto;'><tr><td> Showing " + minpag + " to " + numms + " of " + numms + " - Page " + curms + " of " + pagines + "  <button class='btn' onclick='menysms()'> Previous </button></td></tr></table>";
		 }  else if (curpage == pagines) { // Si has arribat al final de les respostes = al final de la última pàgina, només fletxa Prev
            document.getElementById("respostatext").innerHTML = "<table border='0' style='margin: auto;'><tr><td> Showing " + minpag + " to " + numms + " of " + numms + " - Page " + curms + " of " + pagines + "  <button class='btn' onclick='menysms()'> Previous </button></td></tr></table>";
		} else {
		    document.getElementById("respostatext").innerHTML = "<table border='0' style='margin: auto;'><tr><td> Showing " + minpag + " to " + maxpag + " of " + numms + " - Page " + curms + " of " + pagines + "  <button class='btn' onclick='menysms()'> Previous </button>&nbsp;&nbsp;<button class='btn' onclick='mesms()'> Next </button> </td> </tr> </table>";
		       }
		    }
		 }
      }
...
function afegit () {
  ...
  xhttp.onreadystatechange = function() {
	...
	resp = xmlDoc.getElementsByTagName(valor);
		...
		text += "<table border='0' width='90%'><tr><td width='15%'>Title</td><td>" + respi.getAttribute("titol") + "</td></tr><tr><td width='15%'>Author</td><td>" + respi.getAttribute("author") + "</td></tr><tr><td>Place</td><td>" + respi.getAttribute("settlement1") + ", " + respi.getAttribute("repository1") + ", " + respi.getAttribute("idno1") + "</td></tr></table>";
    ...
    if (xhttp.readyState == 4 && xhttp.status == 200) {
	  ...
	  var mssermolength = mssermo.length;
        ...
        if (casum == null) {  // Primer recompte per saber quantes coincidències hi ha
			document.getElementById("respostatag").innerHTML = "The Database does not contain any sermon from this manuscript. We try to update the DB shortly." + paraula + " --" + casum + "--" + mssermolength + "--" + siwebdig;
			...
			if  ( mssermo[d].getAttribute("author") !="") {
				text += "<table border='0' width='90%'><tr><td width='15%'>Author:</td><td>" + mssermo[d].getAttribute("author") + "</td></tr></table>";
			}	 else {
				 text += "";
				}
			
			if  ( mssermo[d].getAttribute("settlement2") !="") {
				text += "<table border='0' width='90%'><tr><td width='15%'>Information:</td><td>" + mssermo[d].getAttribute("informacio") + "</td></tr></table>";
			}	 else {
				 text += "";
				}
						
			if  ( mssermo[d].getAttribute("editor") !="") {
				text += "<table border='0' width='90%' ><tr><td width='15%'>Edition</td><td>" + mssermo[d].getAttribute("editor") + ", <i>" + mssermo[d].getAttribute("title") + "</i>. " + mssermo[d].getAttribute("pubPlace") + ", " + mssermo[d].getAttribute("publisher") + ", " + mssermo[d].getAttribute("date") + "</td></tr></table>";
			}	 else {
				 text += "";
				}
			...
			if (siwebdig) {
			   text += "<table><tr><td><a href=" + mssermo[d].getAttribute("webdig") + " class='btn' target= '_blank'>Digitised manuscript (Link or Download)</a></td></tr></table>";
			 }	
	   ...
	   var textpdf="";
		...
		for (msc = 0; msc < resposta; msc++) {
		 ...
		 if (curms == 1 && casum == paraula && coincid < maxpag) { //Primera pàgina
		 	 coincid++
			 textms += "<hr/><table border='0' width='90%'><tr><td width='15%'>Place:</td><td>" + atrib[msc].getAttribute("settlement") + ", " + atrib[msc].getAttribute("repository") + ", " + atrib[msc].getAttribute("idno") + "</td></tr><tr><td>Thema:</td><td>" + atrib[msc].children[0].getAttribute("thema_verse") + ": " + atrib[msc].children[0].innerHTML + "</td></tr><tr><td>Author (preacher):</td><td>" + atrib[msc].getAttribute("author") + "</td></tr></table>";
			 
			if  ( atrib[msc].getAttribute("editor") !="") {
				textms += "<table border='0' width='90%'><tr><td width='15%'>Edition:</td><td>" +  atrib[msc].getAttribute("editor") + ", <i>" + atrib[msc].getAttribute("title") + "</i>, " + atrib[msc].getAttribute("pubPlace") + ", " + atrib[msc].getAttribute("publisher") + ", " + atrib[msc].getAttribute("date") + ", " + atrib[msc].getAttribute("pags") + "</td></tr></table>";
			}	 else {
				 textms += "";
				}
			...
			if ( sipdf !="") {
				 textms += "<table border='0' width='90%'><tr><td width='15%'>edition Electronic:</td><td>" + "<a href=" + sipdf + " class='btn' target= '_blank'>Ver PDF</a></td></tr></table>";
			 } else { textms += "";}
		...
		if  (numms == 0) {
			 document.getElementById("tagindoc").innerHTML = "";
			 document.getElementById("tagindoc").innerHTML = "Manuscript en fase de vaciado. Pr&#243;ximamente se especificar&#225;n los sermones que lo componen.";
		 } else if (pagines == 1 && curms ==1) { // Si estàs (al final de la) primera pàgina i només hi ha una pàgina. No posar  fletxes
            document.getElementById("respostatext").innerHTML = "<table border='0' style='margin: auto;'><tr><td> Resultados " + minpag + " to " + coincid + " of " + numms + " - Page " + curms + " of " + pagines + "</td></tr></table>";
		 } else if (curms == 1) { // Si has arribat al final de la primera pàgina, només fletxa Next
            document.getElementById("respostatext").innerHTML = "<table border='0' style='margin: auto;'><tr><td> Resultados " + minpag + " to " + coincid + " of " + numms + " - Page " + curms + " of " + pagines + "  <button class='btn' onclick='mesms()'> Next </button></td></tr></table>";
            ...
            document.getElementById("respostatext").innerHTML = "<table border='0' style='margin: auto;'><tr><td> Resultados " + minpag + " to " + (coincid-1) + " of " + numms + " - Page " + curms + " of " + pagines + "  <button class='btn' onclick='menysms()'> Previous </button></td></tr></table>";
		 }  else if (curpages == pagines) { // Si has arribat al final de les respostes = al final de la última pàgina, només fletxa Prev
            document.getElementById("respostatext").innerHTML = "<table border='0' style='margin: auto;'><tr><td> Resultados " + minpag + " to " + (coincid-1) + " of " + numms + " - Page " + curms + " of " + pagines + "  <button class='btn' onclick='menysms()'> Previous </button></td></tr></table>";
		} else {
		    document.getElementById("respostatext").innerHTML = "<table border='0' style='margin: auto;'><tr><td> Resultados " + minpag + " to " + (coincid-1) + " of " + numms + " - Page " + curms + " of " + pagines + "  <button class='btn' onclick='menysms()'> Previous </button>&nbsp;&nbsp;<button class='btn' onclick='mesms()'> Next </button> </td> </tr> </table>";
		       }
           }
	   }
   }
 ...
 function author () {
  ...
  xhttp.onreadystatechange = function() {
    if (xhttp.readyState == 4 && xhttp.status == 200) {
	  ...
	  s="0";
	  var positius = "0";
	  for (d = 0; d < resposta; d++) { // conta els sermons amb Author buscat
...
//		var msstrobats="0";
//		for (mss = 0; mss < totms; mss++) { // conta els manuscrits amb Author buscat
...
//       }
	   ...
	   for (s = 0; s < resposta; s++) { // resposta = tots els sermons
		 ...
		 if (curauthor == 1 && casos == paraula && coinc < maxpag) { //Primera pàgina
		    coinc++;
		    text += "<hr/><table border='0' width='100%'><tr><td width='15%'>Thema</td><td>" + atrib[s].children[0].getAttribute("thema_verse") + ": " + atrib[s].children[0].innerHTML + "</tr><tr><td>Manuscript: </td><td>" + atrib[s].getAttribute("settlement") + ", " + atrib[s].getAttribute("repository") + ", " + atrib[s].getAttribute("idno") + "</td></tr></table>";
			...
			if  ( sieditor !="") {
				text += "<table border='0' width='100%'><tr><td width='15%'>Edition: </td><td>" + atrib[s].getAttribute("editor") + ", <i>" + atrib[s].getAttribute("title") + "</i>. " + atrib[s].getAttribute("pubPlace") + ", " + atrib[s].getAttribute("publisher") + ", " + atrib[s].getAttribute("date") + ", p. " + atrib[s].getAttribute("pags") +"</td></tr></table>";
				}	 else {
				}
		 ...
		 if  (curauthor > 1 && casos == paraula && coinc < minpag) { // Quan casos < minpag no imprimeixis els resultats pero suma 1 a coinc
			coinc++ 
		 }
		 if  (curauthor > 1 && casos == paraula && coinc >= minpag && coinc <= maxpag) { //Pàgines de la 2 a la última -1
			coinc++
		    text += "<hr/><table border='0' width='100%'><tr><td width='15%'>Thema</td><td>" + atrib[s].children[0].getAttribute("thema_verse") + ": " + atrib[s].children[0].innerHTML + "</tr><tr><td>Manuscript: </td><td>" + atrib[s].getAttribute("settlement") + ", " + atrib[s].getAttribute("repository") + ", " + atrib[s].getAttribute("idno") + "</td></tr></table>";
		 ...
		 if  (pagines ==0 && coinc == 0) {
			document.getElementById("respostatext").innerHTML = "The Database does not contain any sermons for this preacher";
		 } else if (pagines == 1 && curauthor ==1) { // Si estàs (al final de la) primera pàgina i només hi ha una pàgina. No posar  fletxes
            document.getElementById("respostatext").innerHTML = "<table border='0' style='margin: auto;'><tr><td> Showing " + minpag + " to " + positius + " of " + positius + " - Page " + curauthor + " of " + pagines + "</td></tr></table>";
		 } else if (curauthor == 1) { // Si has arribat al final de la primera pàgina, només fletxa Next
            document.getElementById("respostatext").innerHTML = "<table border='0' style='margin: auto;'><tr><td> Showing " + minpag + " to " + maxpag + " of " + positius + " - Page " + curauthor + " of " + pagines + "  <button class='btn' onclick='mesu4()'> Next </button></td></tr></table>";
            ...
            document.getElementById("respostatext").innerHTML = "<table border='0' style='margin: auto;'><tr><td> Showing " + minpag + " to " + positius + " of " + positius + " - Page " + curauthor + " of " + pagines + "  <button class='btn' onclick='menysu4()'> Previous </button></td></tr></table>";
		 }  else if (curauthor == pagines) { // Si has arribat al final de les respostes = al final de la última pàgina, només fletxa Prev
            document.getElementById("respostatext").innerHTML = "<table border='0' style='margin: auto;'><tr><td> Showing " + minpag + " to " + positius + " of " + positius + " - Page " + curauthor + " of " + pagines + "  <button class='btn' onclick='menysu4()'> Previous </button></td></tr></table>";
		} else {
		    document.getElementById("respostatext").innerHTML = "<table border='0' style='margin: auto;'><tr><td> Showing " + minpag + " to " + maxpag + " of " + positius + " - Page " + curauthor + " of " + pagines + "  <button class='btn' onclick='menysu4()'> Previous </button>&nbsp;&nbsp;<button class='btn' onclick='mesu4()'> Next </button> </td> </tr> </table>";
              }
		  }
	   }
   }
	  ...
	  for (d = 0; d < respostafeast; d++) { // calcula coincidències i crea el nombre de pàgines
	   ...
	   for (s = 0; s < respostafeast; s++) { // resposta = tots els sermons
		 ...
		 if (curfeast == 1 && casos == paraula && coinc < maxpag) { //Primera pàgina
			...
			textfeast += "<tr><td>Edition: </td><td>" + atrib[s].getAttribute("editor") + "<i>" + atrib[s].getAttribute("title") + "</i> " + atrib[s].getAttribute("pubPlace") + atrib[s].getAttribute("publisher") + atrib[s].getAttribute("date") + atrib[s].getAttribute("pags") +"</td></tr></table>";
		 ...
		 if  (pagines ==0 && coinc == 0) {
			 document.getElementById("respostatext").innerHTML = "The Database does not contain any sermon for this festivity.";
		 } else if (pagines == 1 && curfeast ==1) { // Si estàs (al final de la) primera pàgina i només hi ha una pàgina. No posar  fletxes
            document.getElementById("respostatext").innerHTML = "<table border='0' style='margin: auto;'><tr><td> 0 Resultados " + minpag + " to " + positiusfeast + " of " + positiusfeast + " - Page " + curfeast + " of " + pagines + "</td></tr></table>";
		 } else if (curfeast == 1) { // Si has arribat al final de la primera pàgina, només fletxa Next
            document.getElementById("respostatext").innerHTML = "<table border='0' style='margin: auto;'><tr><td> Resultados " + minpag + " to " + maxpag + " of " + positiusfeast + " - Page " + curfeast + " of " + pagines + " <button class='btn' onclick='mesu5()'> Next </button></td></tr></table>";
            ...
            document.getElementById("respostatext").innerHTML = "<table border='0' style='margin: auto;'><tr><td><button class='btn' onclick='menysu5()'> Previous </button>&nbsp;&nbsp; Resultados " + minpag + " to " + positiusfeast + " of " + positiusfeast + " - Page " + curfeast + " of " + pagines + "</td></tr></table>";
            ...
            document.getElementById("respostatext").innerHTML = "<table border='0' style='margin: auto;'><tr><td> Resultados " + minpag + " to " + positiusfeast + " of " + positiusfeast + " - Page " + curfeast + " of " + pagines + "  <button class='btn' onclick='menysu5()'> Previous </button></td></tr></table>";
		} else {
		    document.getElementById("respostatext").innerHTML = "<table border='0' style='margin: auto;'><tr><td> Resultados " + minpag + " to " + maxpag + " of " + positiusfeast + " - Page " + curfeast + " of " + pagines + "  <button class='btn' onclick='menysu5()'> Previous </button>&nbsp;&nbsp;<button class='btn' onclick='mesu5()'> Next </button> </td> </tr> </table>";
              }
		  }
	   }
   }
